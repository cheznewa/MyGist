...
rm $tmp/${n}_video.raw
python $MYGIST/radio/avmerge.py 43200 720x576 25 4< $tmp/${n}_audio.raw 7< $tmp/${n}_video.secam | python $MYGIST/radio/radiosend.py $(expr $n \* 10000) $(expr $n \* 10000 + 10000) 16 > $tmp/${n}.radio
