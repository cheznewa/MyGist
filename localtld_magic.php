...
$imgpadlock = base64_encode("<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'><path fill=\"#$color\" fill-rule='evenodd' d='M19 10h1a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V11a1 1 0 0 1 1-1h1V9a7 7 0 0 1 14 0v1zm-2 0V9A5 5 0 1 0 7 9v1h10zm-6 4v4h2v-4h-2z'/></svg>"); // https://github.com/GouvernementFR/dsfr/blob/main/icons/svg/lock-fill.svg
if (!($nonhtml))
echo "<img style='position:fixed;right:8px;top:8px;' src='data:image/svg+xml;base64,$imgpadlock'/>";
?>